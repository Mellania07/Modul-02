//Map (atau kamus) adalah sebuah set pasangan kunci dan nilai (key-value). Kunci bersifat unik dan hanya memiliki satu nilai. Sedangkan nilai yang ada pada Map dapat bernilai ganda/sama.
